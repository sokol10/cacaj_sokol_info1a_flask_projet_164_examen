...
class FormWTFAddFilm(FlaskForm):
    ...
    """
    nom_film_regexp = ""
    nom_film_add_wtf = StringField("Adresse email ", validators=[Length(min=2, max=2000, message="min 2 max 2000"),
                                                               Regexp(nom_film_regexp,
                                                                      message="Email invalide")
                                                               ])

    submit = SubmitField("Enregistrer email")
...
class FormWTFUpdateFilm(FlaskForm):
    ...
    nom_film_update_wtf = StringField("Modifier email", widget=TextArea())
...
class FormWTFDeleteFilm(FlaskForm):
    ...
    """
    nom_film_delete_wtf = StringField("Effacer cet email")
    submit_btn_del_film = SubmitField("Effacer email")
